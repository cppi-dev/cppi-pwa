  ...
  about: {
    ko: {
      ...
      blocks: [
        ...
        { h: "협회 개요", p: "정식 명칭은 한국필라테스교육협회(CPPI Korea)이며 고유번호는 201-82-74381, 비영리 단체로 등록되어 있습니다. 전신은 경기도 성남시 분당에 자리했던 리윰필라테스(Re:yoom Pilates) 아카데미로, 2015년 출판사 등록을 마치고 2017~2018년에 자체 교재를 연달아 발간했습니다. 이 교재 자산을 토대로 2016년 CPPI 한국필라테스교육협회로 재편되었고, 교과정은 2년의 집중 개발 기간을 거쳐 완성되었습니다. 대표이자 협회장은 박은주(Eun-Ju Park)입니다." },
        ...
        { h: "타 단체와의 차별성", list: ["의료 임상 기반 - 창립자가 분당서울대병원 마취통증의학과, 한국보훈복지공단 척추&관절센터에서 근무한 임상 경력을 커리큘럼에 반영", "대학 검증 - 나사렛대학교 스포츠재활학과 겸임교수, 서경대학교 예술교육원 필라테스과정 원장 경력의 창립자 직강", "자체 출판 교재 - 외부 교재 라이선스가 아니라 협회가 직접 집필하고 ISBN을 받아 출판한 9권으로 교육", "실무형 교육 - 동작 암기가 아니라 배리에이션·모디피케이션과 재활 시퀀스 설계를 훈련", "국제 운영 - 한국·캐나다(밴쿠버)·일본(도쿄)에서 운영하며 국제 자격증 발급"] },
  ...
  founder: {
    ko: {
      ...
      blocks: [
        ...
        { h: "저술 - CPPI 교재 9권", p: "CPPI 정규과정에서 쓰는 교재는 전량 자체 집필본입니다. 전신인 리윰필라테스 아카데미 시절 출판사 등록을 마치고 2017~2018년에 걸쳐 발간했으며, 필라테스 기능해부학 238페이지(ISBN 979-11-955431-1-3), 필라테스 기본원리 80페이지(ISBN 979-11-955431-3-7)를 비롯해 매트·리포머·캐딜락·스태빌리티 체어·래더바렐·아크바렐·스파인코렉터까지 총 9권 1,300여 페이지입니다. 각 권은 동작, 운동 목적, 활성화 근육, 큐잉 및 주의사항, 변형 동작이라는 동일한 포맷을 따릅니다." },
